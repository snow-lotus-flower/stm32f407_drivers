 ...
 * a PWM frequency of 1000Hz, turning all channels off and waking it up.
 ...
 * The duty cycle is either directly converted to a 12-bit value used for the
 * PWM timings, if logarithmic is set to false, or an 8-bit value which is then
